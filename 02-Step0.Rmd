# Step 0: Setup and Defaults


**Please setup the appropriate workspace environment**

Please note that it is important to download our ADSNPheno code from [https://github.com/daifengwanglab/adsnpheno](https://github.com/daifengwanglab/adsnpheno) onto your local computer or server, where you can access it. It is recommended that you work with the layout of our existing folders (with our data files and code).
...
<p align="center">
  <img width="400" src="directory.png">
</p>
...
* 1.  Entrez Mapping Information
* 2.  Transcription Factor Information
* 3.  Additional Gene Regulatory Information

<p align="center">
  <img width="500" src="dataDefaults.png">
</p>
...
```{r}
load("data/generalDataForPipeline.RData")
```

These data objects are then loaded, which are then used by the pipeline. 

<p align="center">
  <img width="500" src="loadingGeneralData.png">
</p>
...
To adjust data sources, please note that you can just go to the "data $\rightarrow$  dataDefaults" folder. 
